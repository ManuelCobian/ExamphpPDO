...
<html lang="es">
	<head>
		...
		<meta name="description" content="Examn ">
...
*/
	$(window).load(function() {
		...
		<script src="<?php echo BASE_TEMPLATE.'/'.'assets' ?>/js/vue.min.js" ></script>

		
    <script src="<?php echo BASE_TEMPLATE.'/'.'assets' ?>/js/axios.min.js"></script>
	<script src="<?php echo BASE_TEMPLATE.'/'.'assets' ?>/js/jquery.min.js "></script>
...
<script src="https://npmcdn.com/vue-router/dist/vue-router.js"></script>
		...
		<div class="wrapper">
			...
			<header class="main-header">
				...
				<a href="<?php echo BASE_URL.'?controller=public&action=index' ?>" class="logo">
					...
					<span class="logo-mini"><b>Exa</b>man</span>
					<!-- logo for regular state and mobile devices -->
					<span class="logo-lg"><b>Exa</b>man</span>
						...
						<ul class="nav navbar-nav">
							...
							<li class="dropdown messages-menu">
								<a href="<?php echo BASE_TEMPLATE.'/'.'app' ?>"  class="dropdown-toggle" data-toggle="dropdown">
									...
									<span class="hidden-sm hidden-xs"><?php echo "Administración"?></span>
	...
	<script src="https://cdn.jsdelivr.net/npm/sweetalert2@9"></script>
	<script src="<?php echo BASE_TEMPLATE.'/'.'assets' ?>/js/app.js "></script>
</html>
